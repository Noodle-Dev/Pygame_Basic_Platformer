...
#load images
dirt_img = pygame.image.load('../assets_img/Tiles/gn.png')
grass_img = pygame.image.load('../assets_img/Tiles/grass.png')
blob_img = pygame.image.load('../assets_img/Enemies/enemie_1.png')
platform_x_img = pygame.image.load('../assets_img/Enemies/enemie_1.png')
platform_y_img = pygame.image.load('../assets_img/Enemies/enemie_1.png')
lava_img = pygame.image.load('../assets_img/Enemies/enemie_1.png')
coin_img = pygame.image.load('../assets_img/Enemies/enemie_1.png')
exit_img = pygame.image.load('../assets_img/Enemies/enemie_1.png')
save_img = pygame.image.load('../assets_img/Enemies/enemie_1.png')
load_img = pygame.image.load('../assets_img/Enemies/enemie_1.png')
